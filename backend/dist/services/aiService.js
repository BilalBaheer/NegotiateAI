...
exports.getImprovedText = exports.analyzeText = void 0;
 ...
 */
const analyzeText = async (text, modelId) => {
    if (!text.trim()) {
 ...
 */
const getImprovedText = async (originalText, modelId) => {
...
exports.getImprovedText = getImprovedText;
/**
 ...
 */
const getIndustryContext = (industryModelId) => {
    return INDUSTRY_CONTEXTS[industryModelId] || INDUSTRY_CONTEXTS.general;
};
/**
 * Mock functions for development without API key
 */
const getMockAnalysis = (text, industryModelId) => {
    return {
        score: 75,
        tone: 'Professional',
        sentiment: 'Positive',
 ...
 */
const getMockImprovedText = (originalText) => {
    return `${originalText}\n\n[This would be an improved version of your text with better negotiation techniques and persuasive language.]`;
};
exports.default = {
    analyzeText: exports.analyzeText,
    getImprovedText: exports.getImprovedText
};
